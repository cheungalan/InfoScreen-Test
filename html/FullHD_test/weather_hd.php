...
jQuery(document).ready(function(){
	...
	function get_weather(data){
		...
		$weather_pic.empty().html('').html("<img src=http://www.weather.gov.hk/images/wxicon/pic"+ data.pic + ".png>");
	}
	
	function get_weather_job(){
		jQuery.getJSON("/resource/mdcjob/weather/weather.csv", {}, get_weather);
	}
