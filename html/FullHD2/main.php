...
<TABLE WIDTH=1920 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="border-collapse: collapse" bordercolor="#111111" height="1080" background="images/1920x1080.jpg">
	...
	<TR>
		...
		<TD width="970" height="37">
			<div style="float: left; margin-left: 96px;margin-top:-4px;">
				<img src="images/Logo-CN_White.png" style="height: 50px;">
			</div>	
		</TD>
		...
		<TD width="135" height="37"><?php include_once "weather_hd.php"; ?></TD>
