...
<HTML>
<HEAD>
<TITLE>1080x1920</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=big5">
</HEAD>
<BODY BGCOLOR=#FFFFFF MARGINWIDTH=0 MARGINHEIGHT=0 topmargin="0" leftmargin="0">
<!-- ImageReady Slices (1080x1920.jpg) -->
<TABLE WIDTH=1080 BORDER=0 CELLPADDING=0 CELLSPACING=0 style="border-collapse: collapse" bordercolor="#111111" height="1920" background="images/TV_1080x1920.jpg">
	<TR>
	...
	<TR>
		...
		<TD width="557" height="662" colspan="3" rowspan="3"  align="center"><iframe 
				<?php
					print 'src="media.php?username='.$username.'"'; 
				?>
