...
document.write("<div id=scroller style='position:absolute;background:#FFFFFF;width:620; height:750;left:0; top:0;margin:0px;overflow:hidden;padding:0px;border-style:solid; border-width:0px; border-color:#5C5C5C;'></div>");
...
function action()
{
	...
	{
		innertxt=innertxt+"<div id=d"+i+" style='width:620;position:absolute;border-style:solid; border-width:0px; border-color:#5C5C5C;'>"+content[i]+"</div>";
	}
	...
	for(i=0;i<content.length;i++)
	{
		innertxt=innertxt+"<div id=dz"+i+" style='width:620;position:absolute;border-style:solid; border-width:0px; border-color:#5C5C5C;'>"+content[i]+"</div>";
	}
...
//************************************************************************************
	...
	document.getElementById('sub1').style.width=620+"px";
	document.getElementById('sub2').style.width=620+"px";
