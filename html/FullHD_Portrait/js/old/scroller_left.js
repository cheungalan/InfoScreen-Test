...
//*******************************************************************************************************************
	...
	if (document.getElementById('sub1').style.pixelLeft==1278)
	{
		toplay1 = 4;
		psy1 = new Array();
...
//*******************************************************************************************************************
	...
	if (document.getElementById('sub2').style.pixelLeft==1278)
	{
		toplay2 = 4;
		psy2 = new Array();
...
//*******************************************************************************************************************
	...
	document.getElementById('sub1').style.pixelLeft = document.getElementById('sub1').style.pixelLeft - 1;
	document.getElementById('sub2').style.pixelLeft = document.getElementById('sub2').style.pixelLeft - 1;
