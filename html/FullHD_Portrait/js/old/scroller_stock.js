...
//document.write("<div id=scroller style='position:absolute;background:#FFFFFF;width:1200; height:500;left:0; top:0;margin:0px;overflow:hidden;padding:0px;border-style:solid; border-width:0px; border-color:#5C5C5C;'></div>");
...
function action()
{
	...
	{
		innertxt=innertxt+"<div id=d"+i+" style='width:1762;position:absolute;border-style:solid; border-width:0px; border-color:#5C5C5C;'>"+content[i]+"</div>";
	}
	...
	for(i=0;i<content.length;i++)
	{
		innertxt=innertxt+"<div id=dz"+i+" style='width:1762;position:absolute;border-style:solid; border-width:0px; border-color:#5C5C5C;'>"+content[i]+"</div>";
	}
...
//************************************************************************************
	...
	document.getElementById('sub1').style.width=1762+"px";
	document.getElementById('sub2').style.width=1762+"px";
...
//*******************************************************************************************************************
	...
	if (document.getElementById('sub1').style.pixelTop==500)
	{
		toplay1 = 0;
		psy1 = new Array();
...
*/
		...
		document.getElementById('sub1').style.height=toplay1+"px";
		//document.getElementById('sub1').style.pixelTop=document.getElementById('sub2').style.pixelTop+toplay2;
		//document.getElementById('sub1').style.top=500+"px";
...
//*******************************************************************************************************************
	...
	if (document.getElementById('sub2').style.pixelTop==236)
	{
		toplay2 = 4;
		psy2 = new Array();
...
*/
		...
		document.getElementById('sub2').style.height=toplay2+"px";
		//document.getElementById('sub2').style.pixelTop=document.getElementById('sub1').style.pixelTop+toplay1;
		//document.getElementById('sub2').style.top=500+"px";
	}
